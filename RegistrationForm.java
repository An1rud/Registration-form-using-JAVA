    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == submitButton) {
            if (term.isSelected()) {
                ...
                // Additional code for Excel saving functionality
                saveToExcel();
            } else {
                tout.setText("");
                resadd.setText("");
            ...
            resadd.setText(def);
            // Additional code for resetting Excel-related fields
            nameField.setText("");
            tmno.setText("");
        }
    }

    // Excel saving functionality
    private void saveToExcel() {
        try {
            String fileName = "registration_data.xlsx";
            ...
            dataRow.createCell(0).setCellValue(tname.getText());
            dataRow.createCell(1).setCellValue(tmno.getText());
            dataRow.createCell(2).setCellValue(male.isSelected() ? "Male" : "Female");
            dataRow.createCell(3).setCellValue((String) date.getSelectedItem() + "/" + (String) month.getSelectedItem() + "/" + (String) year.getSelectedItem());
            dataRow.createCell(4).setCellValue(tadd.getText());
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(this, "Error saving data to Excel!");
        }
    }
